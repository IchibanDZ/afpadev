...
const containForbiddenWords = ['nul', 'nuls', 'idiot', 'idiots', 'imbécile', 'imbéciles'];
...
function containForbiddenWords(message){
    ...
    for (let i = 0 ; i < MessageClean.lenght; i++) {
        if (containForbiddenWords.includes(MessageClean[i])){return true
        }
    }
}

module.exports = [containForbiddenWords]